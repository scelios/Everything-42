...
/*   Updated: 2023/03/08 14:54:57 by beaudibe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_check_cmd(t_dlist *dlist)
{
	...
	while (j != 0)
	{
		...
		{
			if ((dlist->cmds[i] == 5 && \
			dlist->cmds[i + ft_nbr_0(dlist, i)] == 7) \
			|| (dlist->cmds[i] == 7 && \
			dlist->cmds[i + ft_nbr_0(dlist, i)] == 5) \
			|| (dlist->cmds[i] == 6 && \
			dlist->cmds[i + ft_nbr_0(dlist, i)] == 8) \
			|| (dlist->cmds[i] == 8 && \
			dlist->cmds[i + ft_nbr_0(dlist, i)] == 6) \
			|| (dlist->cmds[i] == 2 && \
			dlist->cmds[i + ft_nbr_0(dlist, i)] == 1) \
			|| (dlist->cmds[i] == 1 && \
			dlist->cmds[i + ft_nbr_0(dlist, i)] == 2))
			{
				dlist->cmds[i] = 0;
